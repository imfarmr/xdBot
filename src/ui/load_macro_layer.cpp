...
LoadMacroLayer* LoadMacroLayer::create(CompatPopup<>* layer, CompatPopup<>* layer2, bool autosaves) {
...
bool LoadMacroLayer::setup(CompatPopup<>* layer, CompatPopup<>* layer2, bool autosaves) {
...
MacroCell* MacroCell::create(std::filesystem::path path, std::string name, std::time_t date, CompatPopup<>* menuLayer, CompatPopup<>* mergeLayer, CCLayer* loadLayer) {
...
bool MacroCell::init(std::filesystem::path path, std::string name, std::time_t date, CompatPopup<>* menuLayer, CompatPopup<>* mergeLayer, CCLayer* loadLayer) {
